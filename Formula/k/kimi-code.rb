class KimiCode < Formula
  ...
  url "https://registry.npmjs.org/@moonshot-ai/kimi-code/-/kimi-code-0.22.0.tgz"
  sha256 "eaaf944f24373be9eedb6fe79157c6fb5aedee593eb1dd1fc66c3e8b1ba7595b"
  license "MIT"
  ...
  def install
    ...
    if OS.mac?
      ...
      # Remove non-native architecture binaries from `node-pty`
      other_arch = Hardware::CPU.arm? ? "x64" : "arm64"
      rm_r node_modules/"node-pty/prebuilds/darwin-#{other_arch}"
      rm_r node_modules/"native/darwin/prebuilds/darwin-#{other_arch}"
